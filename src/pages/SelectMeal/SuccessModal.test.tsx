...
describe('SuccessModal Component', () => {
  it('renders the success message and button', () => {
    render(<SuccessModal selectedMeals={{ monday: { title: 'Pizza', imageUrl: 'pizza.png' } }} />);
    expect(screen.getByText('Successful')).toBeInTheDocument();
    expect(
      screen.getByText(/The meals you have chosen for the week has successfully been recorded./i),
    ).toBeInTheDocument();
