    ...
    <div className="min-h-screen w-full flex items-center justify-center p-4 sm:p-6 lg:p-10 bg-app-bg">
      <div className="w-full max-w-md lg:max-w-lg bg-surface rounded-3xl p-6 sm:p-10 shadow-[0_15px_50px_rgba(0,0,0,0.06)] border border-border flex flex-col items-center gap-6 text-center font-sans">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xl font-bold text-text-primary tracking-tight">Edziban</span>
        </div>
        ...
        <section className="w-full flex flex-col gap-5 items-center justify-center text-center">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-text-secondary text-sm sm:text-base font-normal max-w-sm leading-relaxed">
        ...
        <section className="w-full flex flex-col gap-4 font-normal mt-2">
          ...
          <AuthLink
            ...
            onClick={() => {}}
            className="text-primary hover:text-primary-hover font-semibold hover:underline text-sm"
          />
        </section>
      </div>
    </div>
