...
export function Activities() {
    ...
    return <div className="h-full w-full">
        ...
        <section className="flex-1 gap-y-6 flex flex-col">
            <h3 className="text-msDeepBlue font-bold text-[18px] mx-4 mt-4 mb-1.5">Activities</h3>
        <Card
        type="activity"
        title="All Menus"
        description="Create and choose menu for the whole week."
        imageUrl={AllMenus}
        onButtonClick={() => { navigate('/admin/menu'); }}
    />
    <Card
        type="activity"
        title="All Meals"
        ...
        imageUrl={AllMeals}
        onButtonClick={() => {navigate('/admin/meal')}}
    />
        <Card
        type="activity"
        title="Choose Meals"
    ...
    />    <Card
        ...
        imageUrl={Reports}
        onButtonClick={() => {navigate('/admin/report')}}
    />
 </section>
    </div>
}